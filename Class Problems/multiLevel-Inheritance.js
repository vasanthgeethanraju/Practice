...
// method describe() → "User: <username>"

// Staff extends User:

// department

// override describe() → "Staff: <username> (<department>)"

// Teacher extends Staff:

// subject

// override describe() → "Teacher: <username> (<department>) - <subject>"
...
class User {
  ...
  class Staff extends User {
    constructor(staffname, department) {
      super();
      this.staffname = staffname;
      this.department = department;
    }
    describe() {
      return `Staff: ${this.staffname} (${this.department})`
    }
  }
  
  class Teacher extends Staff {
    constructor(teachername, teachingDept, subject) {
      super();
    ...
    describe() {
      return `Teacher: ${this.teachername} (${this.teachingdept}) - ${this.subject}`
    }
  }
