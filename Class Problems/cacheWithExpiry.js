...
// Methods: set(key, value, ttlMs), get(key): returns value if not expired, otherwise returns null (or undefined, but be consistent)
...
// Input (simplified, assume no time passed between calls):
const c = new Cache();
c.set("a", 10, 1000);
console.log(c.get("a"));
